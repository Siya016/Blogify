...
export function PricingTable() {
  return (
    <>
      ...
      Whether you're just starting out or scaling up, we’ve got you covered! Choose from a variety of flexible pricing plans designed to suit every need and budget. Enjoy premium features, unmatched support, and exceptional value—perfect for individuals, teams, and businesses alike.
      </p>
